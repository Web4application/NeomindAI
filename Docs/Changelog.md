...
----------------
* Fix for Python 3.9
* Detect msvc from other vswhere file locations

NEW IN WAF 2.1.8
----------------
* Detect free-threaded Pythons

NEW IN WAF 2.1.7
----------------
* Detect free-threaded Pythons
* Work around hash function issues on FIPS-enabled hosts
* Detect prerelease MSVC versions

NEW IN WAF 2.1.6
----------------
* Fix command line option ignored in gnu dirs
* Add msvc side install detection
* Fix msvc version sort
* Fix cuda header detection

NEW IN WAF 2.1.5
----------------
* Enable Clang as assembler
* Improve Qt detection
* Add msvc/arm targets
